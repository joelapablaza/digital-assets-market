        ...
        <Container style={container}>
          ...
          <Section style={informationTable}>
            <Row style={informationTableRow}>
              ...
              <Column style={informationTableColumn}>
                <Text style={informationTableLabel}>FECHA DE FACTURA</Text>
              ...
              <Column style={informationTableColumn}>
                <Text style={informationTableLabel}>ID DE PEDIDO</Text>
                <Link
                  style={{
                    ...informationTableValue,
                  }}
          ...
          <Section style={productTitleTable}>
            <Text style={productsTitle}>Resumen de pedido</Text>
          </Section>
          ...
          <Section>
            ...
            >
              <Text style={productTitle}>Tarifa de transacción</Text>
            </Column>
