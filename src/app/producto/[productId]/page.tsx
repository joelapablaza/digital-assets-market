...
const BREADCRUMBS = [
  ...
  { id: 2, name: 'Productos', href: '/producto' },
];
  ...
  return (
    <MaxWidthWrapper className="bg-background">
          ...
          <div className="lg:max-w-lg lg:self-end">
            ...
            <section className="mt-4">
              <div className="flex items-center">
                ...
                <div className="ml-4 border-l text-muted-foreground border-gray-300 pl-4 dark:border-gray-900">
                  {label}
                </div>
              </div>
      ...
      <ProductReel
        ...
        title={`Similar ${label}`}
        subtitle={`Explora productos de alta calidad ${label} similares a '${product.name}'`}
      />
    </MaxWidthWrapper>
  );
};
