    ...
    <div className="bg-background">
      <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
          ...
          >
            <h2 className="sr-only">Items en tu carrito</h2>
                  ...
                  return (
                    <li key={product.id} className="flex py-6 sm:py-10">
                      ...
                      <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                            ...
                            <div className="flex justify-between">
                              <h3 className="text-sm">
                                <Link
                                  ...
                                  className="font-medium text-gray-700 hover:text-gray-800 dark:text-gray-100 dark:hover:text-gray-50"
                                >
                                  {product.name}
                                </Link>
                              </h3>
                        ...
                        <p className="mt-4 flex space-x-2 text-sm text-gray-700 dark:text-gray-100">
